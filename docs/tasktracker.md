...
- **Статус**: Завершена
- **Описание**: На экране `/schedule` объём и трудозатраты должны отображаться в отдельных колонках справа от названия работы, а не в одной строке с названием. В заголовке добавить колонки «Объём» и «ТЗ».
- **Шаги выполнения**:
  - [x] Изменить заголовок левой части: добавить колонки «Объём» и «ТЗ»
  - [x] В строках задач: убрать объём/трудозатраты из нижней строки названия
  - [x] Добавить отдельные ячейки для объёма и трудозатрат справа от названия
  - [x] Увеличить ширину левой части с w-72 (288px) до w-[360px] для размещения новых колонок
