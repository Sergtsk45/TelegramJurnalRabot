...
### Изменено
- `client/src/pages/Schedule.tsx`: для источника «Смета» в строке задачи дополнительно отображаются **ед. изм.**, **объём** и **трудозатраты (чел.-ч)**, рассчитанные по ресурсам позиции (ОТ+ОТМ, при наличии)
