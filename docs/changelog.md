...
## [2026-02-04] - График работ: объём и трудозатраты в отдельных колонках
### Добавлено
- Нет

### Изменено
- `client/src/pages/Schedule.tsx`: в левой части графика производства работ объём и трудозатраты вынесены в отдельные колонки:
  - Заголовок левой части теперь содержит три колонки: «Задача», «Объём», «ТЗ»
  - В строках задач название работы/позиции занимает отдельную ячейку
  - Объём отображается в отдельной ячейке справа от названия
  - Трудозатраты (чел.-ч) отображаются в отдельной ячейке справа от объёма
  - Общая ширина левой части увеличена с 288px до 360px для размещения новых колонок
